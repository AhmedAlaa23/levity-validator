...
const checkStringLengthRange = (str, min=0, max=null)=>{
...
const isValidPattern = (value, pattern)=>{
...
export
{isDefined,
isString, isAlpha, isAlphaNum, isAlphaNumSpace,
isAlphaNumUnderscore, isAlphaNumDot, isAlphaNumUnderscoreDot, isEmptyString,
isNum, isInt,
isValidPattern};